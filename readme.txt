...
A simple way to add any Custom CSS code to your whole WordPress website or specific post and page.
...
* Individual post or page Custom CSS meta box.
...
2. Type **smart custom css** in the search box and click on search button.
...
2. Unzip.
3. Upload the **smart-custom-css** folder into your plugins directory.
...
2. Customizer.
3. Custom CSS metabox on Post admin screen
